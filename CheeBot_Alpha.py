...
#UI
    def setupUi(self, CheeBotWindow):
        ...
        self.BotInput.returnPressed.connect(self.Botinputting)
        font = QtGui.QFont()
        font.setFamily("Andy")
        font.setPointSize(14)
        font.setBold(True)
...
#Bot
    def Botinputting(self):
        ...
        self.TheInput = self.BotInput.text()
        self.Goodtime = ""
    ...
    def BotExecuteCommand(self):
        try:
            ...
            elif 'youtube' in self.TheInput:
                if 'search' in self.TheInput:
            ...
            elif self.TheInput == "Clear Screen":
                self.BotLog.clear()

            elif self.TheInput == "what time is it":
                self.BotLog.insertPlainText("it is now " + self.Clocktime + "\n")
                self.cheetts.Speak("it is now " + self.Clocktime)

            elif self.TheInput in ["hi", "hello", "hey", "yo", "greetings"]:
                self.timegreet()

            elif "say" in self.TheInput:
            ...
            elif "how are you" in self.TheInput:
            ...
            elif self.TheInput == "flip a coin":
